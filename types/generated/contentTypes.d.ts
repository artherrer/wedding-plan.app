...
export interface ApiEventEvent extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::event.event'> &
      Schema.Attribute.Private;
    locations: Schema.Attribute.Component<'event.location', true>;
...
export interface ApiGuestGuest extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    companions: Schema.Attribute.Relation<
      ...
      'api::companion.companion'
    >;
    confirmed_passes: Schema.Attribute.Integer &
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::guest.guest'> &
      Schema.Attribute.Private;
    max_passes: Schema.Attribute.Integer &
      Schema.Attribute.Required &
      Schema.Attribute.SetMinMax<
        {
          min: 1;
...
export interface ApiTableTable extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    captain_companion: Schema.Attribute.Relation<
      'oneToOne',
      'api::companion.companion'
    >;
    captain_guest: Schema.Attribute.Relation<'oneToOne', 'api::guest.guest'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    event: Schema.Attribute.Relation<'manyToOne', 'api::event.event'>;
